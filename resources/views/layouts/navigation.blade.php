            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @else
                        ...
                        <x-nav-link :href="route('redemptions.index')" :active="request()->routeIs('redemptions.*')">
                            {{ __('My Redemptions') }}
                        </x-nav-link>
                        <x-nav-link :href="route('arduino.connection')" :active="request()->routeIs('arduino.*')">
                            {{ __('Arduino') }}
                        </x-nav-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @else
                ...
                <x-responsive-nav-link :href="route('redemptions.index')" :active="request()->routeIs('redemptions.*')">
                    {{ __('My Redemptions') }}
                </x-responsive-nav-link>
                <x-responsive-nav-link :href="route('arduino.connection')" :active="request()->routeIs('arduino.*')">
                    {{ __('Arduino') }}
                </x-responsive-nav-link>
